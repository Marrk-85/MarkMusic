...
from MARKX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from MARKX.core.call import MARK
from MARKX.utils import seconds_to_min, time_to_seconds
from MARKX.utils.channelplay import get_channeplayCB
from MARKX.utils.database import is_video_allowed
from MARKX.utils.decorators.language import languageCB
from MARKX.utils.decorators.play import PlayWrapper
from MARKX.utils.formatters import formats
from MARKX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from MARKX.utils.inline.playlist import botplaylist_markup
from MARKX.utils.logger import play_logs
from MARKX.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("JayAdmin") & ~BANNED_USERS
)
async def GJ516ymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("GJ516Playlists") & ~BANNED_USERS
)
@languageCB
