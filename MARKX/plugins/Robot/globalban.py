...
from MARKX.utils import get_readable_time
from MARKX.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from MARKX.utils.decorators.language import language
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAICFGNafr_L0eA_vPGhzvxrGkRjn4lPAALlBgACEN3QVnJWzl7_L2nIKgQ")
