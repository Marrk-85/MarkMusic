...
from MARKX.utils.database import (delete_authuser, get_authuser,
                                       get_authuser_names,
                                       save_authuser)
from MARKX.utils.decorators import AdminActual
from MARKX.utils.formatters import int_to_alpha
...
async def auth(client, message: Message, _):
    if not message.reply_to_message:
        ...
        if token not in _check:
            ...
            await message.reply_sticker("CAACAgUAAxkBAAICAAFjWl8w9dh4lvcGlFBq87Tmb9CvWQAChQcAArX02FY9xB43dUS8SSoE")
